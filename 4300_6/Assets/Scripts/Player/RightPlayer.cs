...
public class RightPlayer : MonoBehaviour
{
    ...
    {
        // Horizontal movement
        if (Input.GetAxisRaw("RightPlayerHorizontal_Joystick") == 0)
        {
            horizontalInput = Input.GetAxisRaw("RightPlayerHorizontal_Keyboard");
        }
        else
        {
            horizontalInput = Input.GetAxisRaw("RightPlayerHorizontal_Joystick");
        }

        // Parachute
        if (Input.GetButtonDown("RightPlayerParachute"))
        {
            // Inverts gravity
        ...
        if (Input.GetButtonDown("RightPlayerShoot"))
        {
        ...
        {
            if (Input.GetButton("RightPlayerShoot"))
            {
                if (firingTimer > firingFrequency)
                {
                    InstantiateBullet();
